    ...
    SECTION("FineLayer - basic")
    {
        ...
        xt::xtensor<double, 2> conn_ =
            {{ 0,  1, 17, 16,  4,  5, 21, 20},
             ...
             { 2,  3, 19, 18,  6,  7, 23, 22},
             { 4,  5, 21, 20,  8,  9, 25, 24},
             { 5,  6, 22, 21,  9, 10, 26, 25},
             { 6,  7, 23, 22, 10, 11, 27, 26},
             { 8,  9, 25, 24, 12, 13, 29, 28},
             { 9, 10, 26, 25, 13, 14, 30, 29},
             {10, 11, 27, 26, 14, 15, 31, 30},
             {16, 17, 33, 32, 20, 21, 37, 36},
             {17, 18, 34, 33, 21, 22, 38, 37},
             {18, 19, 35, 34, 22, 23, 39, 38},
             {20, 21, 37, 36, 24, 25, 41, 40},
             {21, 22, 38, 37, 25, 26, 42, 41},
             {22, 23, 39, 38, 26, 27, 43, 42},
             {24, 25, 41, 40, 28, 29, 45, 44},
             {25, 26, 42, 41, 29, 30, 46, 45},
             {26, 27, 43, 42, 30, 31, 47, 46},
             {32, 33, 49, 48, 36, 37, 53, 52},
             {33, 34, 50, 49, 37, 38, 54, 53},
             {34, 35, 51, 50, 38, 39, 55, 54},
             {36, 37, 53, 52, 40, 41, 57, 56},
             {37, 38, 54, 53, 41, 42, 58, 57},
             {38, 39, 55, 54, 42, 43, 59, 58},
             {40, 41, 57, 56, 44, 45, 61, 60},
             {41, 42, 58, 57, 45, 46, 62, 61},
