...
In terms of boundary conditions this implies taking the geometry in horizontal direction,
while the displacements of the top and bottom boundary are fixed.
The out-of-plane direction is furthermore modelled using two-dimensional plane strain.
...
Apply periodicity in this case is rather straightforward.
