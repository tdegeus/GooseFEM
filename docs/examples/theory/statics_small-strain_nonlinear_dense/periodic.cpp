...
#include <GooseMaterial/Metal/LinearStrain/NonLinearElastic.h>
...
// alias
namespace GooseMat = GooseMaterial::Metal::LinearStrain::NonLinearElastic;
...
int main()
{
  ...
  std::vector<GooseMat::Cartesian3d::Material> mat;

  for ( size_t i = 0 ; i < 1 ; ++i )
  {
    // nonlinear elastic material
    GooseMat::Cartesian3d::Material emat = GooseMat::Cartesian3d::Material(1.0,100.0,100.0,2.0);
    // add to list
    mat.push_back(emat);
  }
  ...
  {
    // nonlinear elastic material
    GooseMat::Cartesian3d::Material emat = GooseMat::Cartesian3d::Material(1.0,0.5,0.1,10.0);
    // add to list
    mat.push_back(emat);
  }
