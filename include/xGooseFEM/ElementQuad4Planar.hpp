...
#ifndef XGOOSEFEM_ELEMENTQUAD4PLANAR_CPP
#define XGOOSEFEM_ELEMENTQUAD4PLANAR_CPP
...
inline void QuadraturePlanar::int_gradN_dot_tensor2_dV(const xt::xtensor<double,4> &qtensor,
...
inline void QuadraturePlanar::int_gradN_dot_tensor4_dot_gradNT_dV(const xt::xtensor<double,6> &qtensor,
...
inline xt::xtensor<double,4> QuadraturePlanar::dVtensor() const
{
...
inline xt::xtensor<double,4> QuadraturePlanar::gradN_vector(const xt::xtensor<double,3> &elemvec) const
{
...
inline xt::xtensor<double,4> QuadraturePlanar::gradN_vector_T(const xt::xtensor<double,3> &elemvec) const
{
  xt::xtensor<double,4> qtensor = xt::empty<double>({m_nelem, m_nip, m_tdim, m_tdim});
...
inline xt::xtensor<double,4> QuadraturePlanar::symGradN_vector(const xt::xtensor<double,3> &elemvec) const
{
  xt::xtensor<double,4> qtensor = xt::empty<double>({m_nelem, m_nip, m_tdim, m_tdim});
